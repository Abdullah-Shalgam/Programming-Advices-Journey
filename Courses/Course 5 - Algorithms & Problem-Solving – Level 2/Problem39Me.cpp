...
void CopyOnlyPrimeNumbersFromArray (int ArraySource[100], int ArrayDestination[100], int ArraySourceLength, int &ArrayDestinationLength)
{
...
int main()
{
    ...
    CopyOnlyPrimeNumbersFromArray(Array1, Array2, Array1Length, Array2Length);
    cout << "\nArray 1 Elements:\n";
