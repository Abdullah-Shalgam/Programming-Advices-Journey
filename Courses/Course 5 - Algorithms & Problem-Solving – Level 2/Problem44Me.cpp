...
void FillArrayWithRandomNumbers(int Array [100], int ArrayLength)
{
    ...
    {
        Array [i] = RandomIntNumber(-100, 100);
    }
}

short GetNumberOfPositiveNumbersInArray (int Array [100], int ArrayLength)
{
    int Counter = 0;
    for (int i = 0; i < ArrayLength; i++)
    {
...
int main()
{
    ...
    cout << "\n\nPositive Numbers count is: " << GetNumberOfPositiveNumbersInArray(Array, ArrayLength);
    return 0;
}