...
stDate GetReturnDate(stDate VacationStart, short VacationDays, bool IncludeEndDay = false)
{
    stDate CurrentDate = VacationStart;

    if (IncludeEndDay && !IsWeekEnd(CurrentDate))
    {
        VacationDays--;
    }
