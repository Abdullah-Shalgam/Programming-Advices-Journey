...
bool MarkClientForDeleteByAccountNumber(string AccountNumber, vector <stClient> &vClientRecord)
{
...
vector <stClient> SaveCleintsDataToFile(string FileName, vector<stClient> &vClientRecord)
{
    fstream MyFile;
