...
string JoinText(string arrText[], short arrLength, string Delim = " ")
{
    string sWord = "";
    for (short i = 0; i < arrLength; i++)
    {
        sWord += arrText[i] + Delim;
    }
    return sWord.substr(0, (sWord.length() - Delim.length()));
}
...
int main()
{
    ...
    string Delim = "---";
    vector <string> vText;
    string arrText[] = {"Mohammed", "Ahmed", "Khalid", "Ali", "Abdullah."};
    ...
    cout << "\nPrint Join Array Using (--):-\n\n";
    cout << JoinText(arrText, 5, "--");
    return 0;
}