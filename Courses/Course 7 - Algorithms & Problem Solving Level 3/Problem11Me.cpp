...
{
    return (GetSumOfMatrix(Matrix1, Rows, Columns) == GetSumOfMatrix(Matrix2, Rows, Columns));
}

void PrintSparceOrNot(bool AreEqualMatrices)
{
    if (AreEqualMatrices)
...
int main()
{
    ...
    cout << endl;
    PrintSparceOrNot(AreEqualMatrices(Matrix1, Matrix2, 3, 3));
    return 0;
}